...
gaspi_logger &
mpiexec -n 56 --perhost 28 amplxe-cl --collect hotspots -r /dss/dsshome1/lxc06/ga53qud2/actor-gpi-v2/amplifier-analysis/GPIweak2/ampli ./pond -x 4096 -y 4096 -p 256 -e 1 -c 1 --scenario 2 -o output/out

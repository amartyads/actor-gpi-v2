...
#SBATCH --exclude=i22r06c05s[09-10],i22r05c03s01,i22r04c02s01,i22r02c02s09,i22r02c05s02,i22r02c05s01
...
gaspi_logger &
mpiexec -n 160 --perhost 10 ./pond -x 16384 -y 16384 -p 256 -e 1 -c 1 --scenario 2 -o output/out

...
gaspi_logger &
mpiexec -n 320 --perhost 10 amplxe-cl --collect hotspots -r /dss/dsshome1/lxc06/ga53qud2/actor-gpi-v2/amplifier-analysis/GPIweak32/ampli ./pond -x 16384 -y 16384 -p 256 -e 1 -c 1 --scenario 2 -o output/out

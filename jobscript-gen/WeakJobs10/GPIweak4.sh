...
#SBATCH --exclude=i22r06c05s[09-10],i22r07c04s12,i22r03c04s07,i22r06c04s01,i22r02c05s10,i22r06c03s04
...
gaspi_logger &
mpiexec -n 40 --perhost 10 ./pond -x 4096 -y 8192 -p 256 -e 1 -c 1 --scenario 2 -o output/out
